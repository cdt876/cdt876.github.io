...
<FORM ACTION=/cgi-bin/gsatools/acl/acl_list.cgi METHOD=Post ENCTYPE=application/x-www-form-urlencoded ONSUBMIT="javascript:return submittedForm(document.forms.GSAToolForm)" TARGET=_self NAME=GSAToolForm>
<CENTER>
...
<TR><TD align=left><INPUT TYPE=checkbox NAME=object_acls checked VALUE=yes><SPAN CLASS="inputdesc">List Current Path ACLs</SPAN><BR><INPUT TYPE=checkbox NAME=default_acls checked VALUE=yes><SPAN CLASS="inputdesc">List Inheritance ACLs<BR><INPUT TYPE=hidden NAME=workingcell VALUE=/gsa/ausgsa></TD></TR>

...
<TR><TD align=left><INPUT TYPE=hidden NAME=LACTION VALUE="group_spcrpt"></TD></TR></TABLE>
<!--
<BR>
<TABLE CLASS="basic-table" BORDER="0" CELLSPACING=0 CELLPADDING=2 WIDTH=410>
  <TR ALIGN=CENTER>
...
<TR><TD align=left><INPUT TYPE=hidden NAME=LACTION VALUE="group_spcrpt"></TD></TR></TABLE></TD>
  </TR>
  <TR>
...
<SCRIPT LANGUAGE="JavaScript1.2">
  top.setCookie("GSAApplication", "group");
...
write('<p><input type=button value="Click for more help" onClick=window.open("../../gsadoc/help/group.shtml#srpt")>');

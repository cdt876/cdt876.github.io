...
<CENTER>
<script language='javascript' src='http://ausxgsasd8.austin.ibm.com/gsatools/refreshimage.js'></script>
...
<INPUT TYPE=hidden NAME=LACTION VALUE="tdisk_query"></TD></TR>
  <TR>
   ...
   <SCRIPT LANGUAGE="JavaScript">
<!--
//document.images['submitimg'].src = "http://ausxgsasd8.austin.ibm.com/gsatools/images/wsmsubmit.gif";
// -->
   </SCRIPT>
